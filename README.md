...
Day 3 — Layer 1 expert: gates = MOSFETs pulling wires, propagation delay & critical path set clock speed, NAND/NOR cheaper than AND/OR, built a half-adder (XOR=sum, AND=carry)    
